    ...
    <div ref={dropdownRef} className="relative inline-block text-left z-30">
      ...
      {isOpen && (
        <div
          ...
          role="menu"
        >
          <div className="px-2 py-1 text-xs font-bold uppercase tracking-wider opacity-70">
          ...
          >
            ...
            <div>
              <div className="font-semibold text-xs md:text-sm" style={{ color: "var(--foreground)" }}>
                SQL Script (.sql)
              </div>
              <div className="text-xs opacity-75" style={{ color: "var(--muted)" }}>
          ...
          {/* Export CSV Option */}
          <div className="px-2 py-1 text-xs font-semibold opacity-80">
            CSV Format (.csv)
          </div>
          ...
          {activeSchema.length > 1 && (
            <button
              ...
              className="w-full text-left px-2.5 py-1.5 rounded-lg flex items-center gap-2 transition-colors cursor-pointer hover:bg-[var(--surface-hover)] font-medium text-emerald-500 text-xs"
            >
          ...
          {activeSchema.map((table) => (
            ...
            >
              <span className="flex items-center gap-2">
                ...
                <span className="font-mono text-xs">{table.name}.csv</span>
              </span>
