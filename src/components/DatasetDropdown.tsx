          ...
          >
            {datasets.map((dataset) => {
              ...
              return (
                <div
                  key={dataset.id}
                  className={`dataset-option w-full rounded-lg px-3 py-2 text-left flex items-center justify-between gap-2 ${selected ? "dataset-option-selected" : ""
                    }`}
                >
                  <button
                    type="button"
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    {onEditDataset && (
                      <button
                        ...
                        className="dataset-edit-btn p-1.5 text-xs rounded-md border border-slate-400/60 dark:border-zinc-700 hover:border-black dark:hover:border-white hover:bg-slate-200/80 dark:hover:bg-zinc-700 cursor-pointer flex items-center justify-center transition-colors"
                        style={{ color: "var(--foreground)" }}
                        onClick={(e) => {
                          e.stopPropagation();
                          setOpen(false);
                    ...
                    {onDeleteDataset && (
                      <button
                        ...
                        className="p-1.5 text-xs rounded-md border border-red-400 hover:border-red-600 hover:bg-red-50/80 cursor-pointer flex items-center justify-center transition-colors"
                        style={{ color: "#dc2626" }}
                        onClick={(e) => {
                          e.stopPropagation();
