  ...
  return (
    ...
    >
      ...
      <div className="space-y-8">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">01</span>
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">02</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1.5">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-[var(--accent)]">Core Linguistic Pipeline</h3>
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-[var(--accent)]">Transformer Neural Architectures</h3>
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">03</span>
            What is SQL?
          </h2>
          <p className="text-sm md:text-base opacity-90 leading-relaxed">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">04</span>
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">05</span>
            Why NL→SQL is Useful
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1.5">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-emerald-400">Data Democratization</h3>
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-sky-400">Sub-Second Turnaround</h3>
              <p className="text-sm opacity-80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-amber-400">Voice Querying &amp; Accessibility</h3>
              <p className="text-sm opacity-80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-purple-400">Pedagogical DBMS Instruction</h3>
              <p className="text-sm opacity-80 leading-relaxed">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">06</span>
        ...
        >
          <div>
            <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
              <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">07</span>
          ...
          >
            ...
            <span className="text-lg opacity-70 font-bold text-[var(--accent)]">↓</span>
            <span className="font-semibold text-sm md:text-base px-4 py-1.5 rounded-md bg-[var(--panel)] border text-[var(--foreground)]">
          ...
          <div className="space-y-3 pt-2">
            <h3 className="font-bold text-base md:text-lg" style={{ color: "var(--foreground)" }}>
              Worked Example:
            </h3>

            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-1" style={{ borderColor: "var(--border)" }}>
              <span className="text-xs font-semibold text-[var(--accent)] uppercase tracking-wider block">
                User Input:
              </span>
              <p className="text-sm md:text-base font-medium italic" style={{ color: "var(--foreground)" }}>
...
WHERE city = 'Mumbai';`}
            ...
            <div className="space-y-2.5 pt-1">
              <h4 className="font-semibold text-sm md:text-base" style={{ color: "var(--foreground)" }}>
                Clause-by-Clause Explanation:
              </h4>
              <ul className="space-y-2.5 text-sm md:text-base opacity-90 pl-1">
                <li className="p-3.5 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">08</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-[var(--accent)]">Types of Schema Linking</h3>
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-[var(--accent)]">Context Pruning for Large Databases</h3>
              <p className="text-sm md:text-base opacity-85 leading-relaxed">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">09</span>
            NLP→SQL Deep Dive: Constrained Decoding &amp; Self-Repair
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-sky-400">Grammar-Constrained Decoding</h3>
              <p className="text-sm md:text-base opacity-85 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-emerald-400">Execution-Guided Decoding (EGD)</h3>
              <p className="text-sm md:text-base opacity-85 leading-relaxed">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">10</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-1">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-[var(--accent)]">1. Lexical Analysis</h3>
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-[var(--accent)]">2. Syntactic Parsing</h3>
              <p className="text-xs md:text-sm opacity-80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5 text-[var(--accent)]">3. Semantic Analysis</h3>
              <p className="text-xs md:text-sm opacity-80 leading-relaxed">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">11</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pt-1">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <div className="font-mono font-bold text-sm text-[var(--accent)]">Selection (WHERE / Filter)</div>
              <p className="text-xs md:text-sm opacity-80 mt-1.5">Filters rows matching a boolean predicate: <code className="font-mono">Filter[city=&apos;Mumbai&apos;](customers)</code></p>
            </div>
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <div className="font-mono font-bold text-sm text-[var(--accent)]">Projection (SELECT)</div>
              <p className="text-xs md:text-sm opacity-80 mt-1.5">Extracts specified columns: <code className="font-mono">Project[name, city](customers)</code></p>
            </div>
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <div className="font-mono font-bold text-sm text-[var(--accent)]">Join (JOIN / Condition)</div>
              <p className="text-xs md:text-sm opacity-80 mt-1.5">Combines matching tuples: <code className="font-mono">Orders JOIN[cust_id=id] Customers</code></p>
            </div>
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <div className="font-mono font-bold text-sm text-[var(--accent)]">Aggregation (GROUP BY)</div>
              <p className="text-xs md:text-sm opacity-80 mt-1.5">Partitions data into buckets and calculates summaries: <code className="font-mono">GroupBy[dept, COUNT(id)](Employees)</code></p>
            </div>
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <div className="font-mono font-bold text-sm text-[var(--accent)]">Cartesian Product (CROSS JOIN)</div>
              <p className="text-xs md:text-sm opacity-80 mt-1.5">Computes every combination of tuples: <code className="font-mono">R CROSS JOIN S</code></p>
            </div>
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <div className="font-mono font-bold text-sm text-[var(--accent)]">Set Operations (UNION / EXCEPT)</div>
              <p className="text-xs md:text-sm opacity-80 mt-1.5">Union, Difference, and Intersection operations on union-compatible relations.</p>
            </div>
          </div>
        </section>
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">12</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-amber-400">Rule-Based Heuristic Optimization (RBO)</h3>
              <p className="text-xs md:text-sm opacity-80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-emerald-400">Cost-Based Optimization (CBO)</h3>
              <p className="text-xs md:text-sm opacity-80 leading-relaxed">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">13</span>
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">14</span>
            Storage Engine, Slotted Pages &amp; Buffer Pool Manager
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-[var(--accent)]">Slotted-Page Architecture</h3>
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-[var(--accent)]">Buffer Pool &amp; WAL Durability</h3>
              <p className="text-xs md:text-sm opacity-85 leading-relaxed">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">15</span>
            Integrity Constraints &amp; Normalization Theory
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm md:text-base">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-[var(--foreground)]">Relational Integrity Guarantees</h3>
              <ul className="list-disc list-inside opacity-85 space-y-1.5 text-xs md:text-sm">
                ...
                <li><strong>Referential Integrity:</strong> Foreign key values must match a valid primary key in the referenced relation or be NULL. Actions include <code className="font-mono text-xs">CASCADE</code>, <code className="font-mono text-xs">SET NULL</code>, and <code className="font-mono text-xs">RESTRICT</code>.</li>
              </ul>
            </div>
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-[var(--foreground)]">Normalization Forms (1NF → BCNF)</h3>
              <ul className="list-disc list-inside opacity-85 space-y-1.5 text-xs md:text-sm">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">16</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs md:text-sm">
            <div className="p-3.5 rounded-lg border bg-[var(--surface-subtle)] space-y-1" style={{ borderColor: "var(--border)" }}>
              <strong className="block text-sm text-[var(--accent)]">Read Uncommitted</strong>
              <p className="opacity-75 leading-relaxed text-xs">Permits Dirty Reads, Non-Repeatable Reads, and Phantoms. Highest concurrency, lowest safety.</p>
            </div>
            <div className="p-3.5 rounded-lg border bg-[var(--surface-subtle)] space-y-1" style={{ borderColor: "var(--border)" }}>
              <strong className="block text-sm text-[var(--accent)]">Read Committed</strong>
              <p className="opacity-75 leading-relaxed text-xs">Prevents Dirty Reads. Queries see only committed data at statement invocation time.</p>
            </div>
            <div className="p-3.5 rounded-lg border bg-[var(--surface-subtle)] space-y-1" style={{ borderColor: "var(--border)" }}>
              <strong className="block text-sm text-[var(--accent)]">Repeatable Read</strong>
              <p className="opacity-75 leading-relaxed text-xs">Prevents Dirty Reads and Non-Repeatable Reads. Snapshot isolation prevents mid-transaction tuple changes.</p>
            </div>
            <div className="p-3.5 rounded-lg border bg-[var(--surface-subtle)] space-y-1" style={{ borderColor: "var(--border)" }}>
              <strong className="block text-sm text-[var(--accent)]">Serializable</strong>
              <p className="opacity-75 leading-relaxed text-xs">Guarantees strict serializable execution as if transactions executed one after another. Prevents Phantoms.</p>
            </div>
          </div>
        </section>
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">17</span>
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">18</span>
            Advantages &amp; Limitations of Modern NL→SQL
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm md:text-base">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-emerald-400">Advantages</h3>
              <ul className="list-disc list-inside opacity-85 space-y-1.5 text-xs md:text-sm">
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)] space-y-2" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-bold text-sm md:text-base text-rose-400">Limitations &amp; Challenges</h3>
              <ul className="list-disc list-inside opacity-85 space-y-1.5 text-xs md:text-sm">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">19</span>
            Real-World Applications &amp; Industry Deployments
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5">Business Intelligence &amp; Analytics</h3>
              <p className="text-xs md:text-sm opacity-80 leading-relaxed">
                Integrated copilots in tools like Snowflake, BigQuery, Tableau, and PowerBI enabling natural language metric dashboards.
              </p>
            </div>
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5">Healthcare &amp; Clinical Informatics</h3>
              <p className="text-xs md:text-sm opacity-80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5">E-Commerce &amp; Inventory Management</h3>
              <p className="text-xs md:text-sm opacity-80 leading-relaxed">
                Logistics directors querying stock anomalies, transit times, and regional sales spikes conversationally.
              </p>
            </div>
            <div className="p-4 rounded-lg border bg-[var(--surface-subtle)]" style={{ borderColor: "var(--border)" }}>
              <h3 className="font-semibold text-sm md:text-base mb-1.5">Autonomous Multi-Agent Systems</h3>
              <p className="text-xs md:text-sm opacity-80 leading-relaxed">
        ...
        >
          <h2 className="text-lg md:text-xl font-bold flex items-center gap-2.5" style={{ color: "var(--foreground)" }}>
            <span className="text-sm font-mono px-2.5 py-1 rounded bg-[var(--surface-subtle)] text-[var(--accent)] border border-[var(--border)]">20</span>
            Summary &amp; Takeaways
          </h2>
          <p className="text-sm md:text-base opacity-90 leading-relaxed">
        ...
        >
          <div>
            ...
            <h2 className="text-lg md:text-2xl font-bold" style={{ color: "var(--foreground)" }}>
          ...
          <p className="text-xs md:text-sm opacity-75 italic" style={{ color: "var(--muted)" }}>
